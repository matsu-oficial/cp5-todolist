package matsu_oficial.com.github.todolist.ui

import matsu_oficial.com.github.todolist.data.Tarefa
import matsu_oficial.com.github.todolist.util.formatarDataHora
...
private fun ListaTarefasContentPreview() {
    ListaTarefasContent(
        tarefas = listOf(
            Tarefa(id = 1, titulo = "Tirar o lixo", descricao = "Para não esquecer", concluida = false),
...
private fun TarefaItemPreview() {
    TarefaItem(
        tarefa = Tarefa(id = 1, titulo = "Tirar o lixo", descricao = "Para não esquecer", concluida = false),
        onCheckedChange = {},
        onEditar = {},
        onDeletar = {}
    )
...
private fun TarefaItemAtrasadaPreview() {
    ...
    TarefaItem(
        tarefa = Tarefa(
            id = 4,
            titulo = "Boliche",
            descricao = "Estar no shopping sem atraso",
            concluida = false,
            dataHora = prazo
        ),
        onCheckedChange = {},
